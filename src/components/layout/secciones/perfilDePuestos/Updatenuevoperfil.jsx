...
class Updatenuevoperfil extends Component {
    constructor(props){
        super(props)
        this.state={
            ...
            Horario:this.props.InfoPuesto.Horario,
            Proposito:this.props.InfoPuesto.Proposito,
            Directamente:this.props.InfoPuesto.Directamente,
            Edad:this.props.InfoPuesto.Edad,
            Sexo:this.props.InfoPuesto.Sexo,
            Escolaridad:this.props.InfoPuesto.Escolaridad,
            Experiencia:this.props.InfoPuesto.Experiencia,
            Manejo:this.props.InfoPuesto.Manejo,
            Oficina:this.props.InfoPuesto.Oficina,
            Otros:this.props.InfoPuesto.Otros,
            Elaboro:this.props.InfoPuesto.Elaboro,
            Reviso:this.props.InfoPuesto.Reviso,
            Autorizo:this.props.InfoPuesto.Autorizo,
            Fecha:this.props.InfoPuesto.Fecha,
    ...
    render() {
        ...
        <div className="row mt-4 mb-5">
            ...
            <div className="col-12 mt-4">
                <button className="btn btn-general btn-block" onClick={()=>this.CrearPuesto()}>Editar Puesto</button>
            </div>
        </div>
        )
    }
